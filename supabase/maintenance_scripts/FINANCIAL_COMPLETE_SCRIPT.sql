-- =====================================================
-- SCRIPT CONSOLIDADO - MÓDULO FINANCEIRO COMPLETO (CORRIGIDO)
-- Execute este script inteiro de uma vez no Supabase SQL Editor
-- =====================================================

-- =====================================================
-- PARTE 1: SCHEMA (TABELAS, ÍNDICES, TRIGGERS, RLS)
-- =====================================================
...
-- Transações: todos podem inserir, mas só o criador ou admins podem editar
...
-- =====================================================
-- PARTE 2: SEED DATA (DADOS INICIAIS)
-- =====================================================
...
-- CLASSES FINANCEIRAS (com relacionamentos)
DO $$
DECLARE
    v_sga_id UUID;
    v_socios_id UUID;
