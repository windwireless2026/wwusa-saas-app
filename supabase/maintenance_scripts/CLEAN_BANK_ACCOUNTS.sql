-- =====================================================
-- LIMPAR E RECRIAR BANK ACCOUNTS
-- =====================================================

-- 1. Dropar tudo que existe
DROP TRIGGER IF EXISTS bank_accounts_updated_at ON bank_accounts;
DROP FUNCTION IF EXISTS update_bank_accounts_updated_at();
...
CREATE INDEX idx_bank_accounts_account_code ON bank_accounts(account_code);
