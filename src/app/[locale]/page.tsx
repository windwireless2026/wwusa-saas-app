    ...
    <main style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#ffffff' }}>
      ...
      <section style={{ padding: '80px 0', background: '#0f172a', color: 'white' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '40px', textAlign: 'center' }}>
          ...
          <div>
            <h3 style={{ fontSize: '48px', fontWeight: '900', marginBottom: '8px', color: '#60a5fa' }}>100+</h3>
            <p style={{ color: '#94a3b8', fontSize: '14px', fontWeight: '600', textTransform: 'uppercase' }}>{tStats('partners')}</p>
          </div>
          <div>
            <h3 style={{ fontSize: '48px', fontWeight: '900', marginBottom: '8px', color: '#60a5fa' }}>MIAMI</h3>
            <p style={{ color: '#94a3b8', fontSize: '14px', fontWeight: '600', textTransform: 'uppercase' }}>{tStats('hq')}</p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '100px', alignItems: 'center' }}>
            <div style={{ position: 'relative', height: '600px', borderRadius: '32px', overflow: 'hidden' }}>
              <Image src="/images/quality_check.png" alt="Quality Inspection" fill style={{ objectFit: 'cover' }} />
            </div>
            <div>
              ...
              <p style={{ fontSize: '18px', color: '#475569', marginBottom: '24px', lineHeight: '1.7' }}>{tAbout('p1')}</p>
              <p style={{ fontSize: '18px', color: '#475569', marginBottom: '40px', lineHeight: '1.7' }}>{tAbout('p2')}</p>
              <div style={{ display: 'grid', gap: '20px' }}>
                {[1, 2, 3].map((i) => (
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '16px', padding: '20px', background: '#f8fafc', borderRadius: '16px', border: '1px solid #e2e8f0' }}>
                    <div style={{ width: '40px', height: '40px', background: '#2563eb', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 'bold' }}>✓</div>
      ...
      <section id="products" style={{ padding: '140px 0', background: '#f8fafc' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '32px' }}>
            {[1, 2, 3].map((i) => (
              <div key={i} className="glass-panel" style={{ padding: '40px', background: 'white', borderRadius: '24px' }}>
        ...
        <div className="container" style={{ maxWidth: '1000px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: '80px', alignItems: 'center' }}>
            <div>
              ...
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ background: '#25d366', padding: '20px 32px', fontSize: '18px', gap: '12px' }}>
            ...
            <div style={{ background: '#f8fafc', padding: '48px', borderRadius: '32px', border: '1px solid #e2e8f0' }}>
              ...
              <div style={{ display: 'grid', gap: '24px' }}>
                <div>
                  ...
                  <input type="text" style={{ width: '100%', padding: '14px 18px', borderRadius: '12px', border: '1px solid #cbd5e1' }} placeholder="..." />
                </div>
                <div>
                  ...
                  <input type="email" style={{ width: '100%', padding: '14px 18px', borderRadius: '12px', border: '1px solid #cbd5e1' }} placeholder="..." />
                </div>
                <div>
                  ...
                  <textarea rows={4} style={{ width: '100%', padding: '14px 18px', borderRadius: '12px', border: '1px solid #cbd5e1', resize: 'none' }} placeholder="..." />
                </div>
