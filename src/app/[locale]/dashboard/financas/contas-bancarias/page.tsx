    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (editing) {
                ...
                await alert('Sucesso', 'Conta atualizada!', 'success');
            } else {
                const { error } = await supabase
                    .from('bank_accounts')
                    .insert({
    ...
    return (
        <div style={{ padding: '40px', minHeight: '100vh', background: '#f8fafc' }}>
            ...
            <div style={{ marginBottom: '24px', fontSize: '14px', color: '#64748b' }}>
                📋 <a href="/dashboard/registration" style={{ fontWeight: '600', color: '#3b82f6', textDecoration: 'none', cursor: 'pointer' }}>Cadastro</a> › Contas Bancárias
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px' }}>
                <div>
                    ...
                    <p style={{ color: '#64748b', marginTop: '8px' }}>
                        Gerencie contas bancárias, crypto wallets e contas gerenciais
                    </p>
                </div>
                <button
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={e => {
                                                        ...
                                                        setFormData({ ...formData, routing_number: routing });
                                                        // Auto-preencher instituição baseado no routing
                                                        // TODO: Integrar API de routing numbers
                                                    }}
                                                    required
