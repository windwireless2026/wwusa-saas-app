    ...
    return (
        <div style={{ padding: '40px', minHeight: '100vh', background: '#f8fafc' }}>
            <PageHeader
                ...
                description="Classificações e categorizações financeiras do sistema"
                icon="📂"
                breadcrumbs={[
                    { label: 'PLANO FINANCEIRO', href: '/finance', color: '#059669' },
                    { label: 'PLANO DE CONTAS FINANCEIRO', color: '#059669' },
                ]}
                moduleColor="#059669"
                actions={
                    <button
