  ...
  const configuracoesEmpresa = [
    {
      ...
      description: 'Informações cadastrais e configurações gerais',
  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      <h2 style={{ 
        ...
        <span>🏢</span> Configurações da Empresa
      </h2>
      ...
      <div style={{ 
        ...
        {configuracoesEmpresa.map((item, index) => (
          <div
            key={index}
